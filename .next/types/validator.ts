...
// Validate ../../src/app/admin/add-support/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/admin/add-support">> = Specific
  const handler = {} as typeof import("../../src/app/admin/add-support/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
