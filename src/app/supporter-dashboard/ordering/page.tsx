...
const translations = {
  en: {
    ...
    welcomeMessage:
      "Here you can manage your online menu, track orders, and view sales reports. Select an option from the sidebar to get started.",
  ...
  zh: {
    ...
    welcomeMessage:
      "您可以在此管理您的在线菜单、跟踪订单并查看销售报告。请从侧边栏中选择一个选项开始。",
    salesToday: "今日销售",
    pendingOrders: "待处理订单",
    newCustomers: "新顾客",
    comingSoon: "即将推出",
  ...
  return (
    <div>
      ...
      {supporterId ? (
        ...
        <div className="text-red-500 font-semibold">{/* fallback if no supporterId */}</div>
      )}
    </div>
  );
}
